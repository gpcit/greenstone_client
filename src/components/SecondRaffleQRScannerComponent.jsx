...
import { scanSecondRaffle } from "../services/raffleWinnerServices";

const SecondRaffleQRScanner = () => {
  ...
  const handleScan = useCallback(
    async (data) => {
      ...
      try {
        const guest = await scanSecondRaffle(trimmedData);
  ...
  return (
    <>
      <GridLoaders
        ...
        message={"Congratulations! You are a Second Raffle Winner!"}
      />
      <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
        {status === "idle" && (
          <>
            <h2 className="text-xl font-bold mb-4">📷 Scan QR Second Raffle</h2>
...
export default SecondRaffleQRScanner;
