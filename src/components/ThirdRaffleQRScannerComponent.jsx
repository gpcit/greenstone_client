...
import { scanThirdRaffle } from "../services/raffleWinnerServices";

const ThirdRaffleQRScanner = () => {
  ...
  const handleScan = useCallback(
    async (data) => {
      ...
      try {
        const guest = await scanThirdRaffle(trimmedData);
  ...
  return (
    <>
      <GridLoaders
        ...
        message={"Congratulations! You are a Third Raffle Winner!"}
      />
      <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
        {status === "idle" && (
          <>
            <h2 className="text-xl font-bold mb-4">📷 Scan QR Third Raffle</h2>
...
export default ThirdRaffleQRScanner;
